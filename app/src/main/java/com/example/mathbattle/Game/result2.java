...
public class result2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        finalscore=(TextView) findViewById(R.id.txtresultScore1);
        Wanswers=(TextView) findViewById(R.id.txt_wrongAns1);
        Ranswers=(TextView) findViewById(R.id.txt_rightAns1);
        close=(Button)findViewById(R.id.btnmain);
        MediaPlayer mp = MediaPlayer.create(result2.this,R.raw.loose);
        mp.start();
        close.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(result2.this, MainMenu.class);
